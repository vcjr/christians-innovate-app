          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {profiles.map((profile) => {
              ...
              return (
                <div
                  key={profile.id}
                  className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition flex flex-col"
                >
                  {/* Avatar and Name */}
              ...
              {ownedGroups.map(group => {
                ...
                return (
                  <button
                    ...
                    disabled={disabled}
                    className={`w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl text-left transition ${disabled
